<?php
/**
 * Pattern: Three pricing cards with list and button
 *
 * @package Boo Theme
 * @since 0.0.1
 */
...
return array(
	'title'      => __( 'Three pricing cards with list and button.', 'boo' ),
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"white","layout":{"inherit":true}} -->
									...
									<p class="has-text-align-center">' . esc_html__( 'Create a three-column layout showing prices.', 'boo' ) . '</p>
									<!-- /wp:paragraph -->
									...
									<div class="wp-block-group" style="padding-top:30px;padding-right:40px;padding-bottom:40px;padding-left:40px"><!-- wp:list {"textColor":"primary","className":"pricing-table","fontSize":"medium"} -->
									<ul class="pricing-table has-primary-color has-text-color has-medium-font-size"><li>Feature #1</li><li>Feature #2</li><li>Feature #3</li><li>Feature #4</li><li>Feature #5</li></ul>
									<!-- /wp:list -->
									...
									<div class="wp-block-button"><a class="wp-block-button__link">' . esc_html__( 'Get it', 'boo' ) . '</a></div>
									<!-- /wp:button --></div>
									<!-- /wp:buttons --></div>
									<!-- /wp:group --></div>
									<!-- /wp:group --></div>
									...
									<div class="wp-block-column"><!-- wp:group {"style":{"border":{"width":"1px","style":"solid","radius":"5px"}},"borderColor":"primary","className":"has-black-border"} -->
									<div class="wp-block-group has-black-border has-border-color has-primary-border-color" style="border-radius:5px;border-style:solid;border-width:1px"><!-- wp:heading {"textAlign":"center","level":4,"style":{"spacing":{"margin":{"bottom":"0px"}}},"backgroundColor":"primary","textColor":"white"} -->
									<h4 class="has-text-align-center has-white-color has-primary-background-color has-text-color has-background" id="professional-295" style="margin-bottom:0px">Professional - $295</h4>
									<!-- /wp:heading -->
