...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"white","layout":{"inherit":true}} -->
									...
									<!-- wp:heading {"textAlign":"center","level":3,"style":{"spacing":{"margin":{"bottom":"20px"}},"typography":{"fontStyle":"normal","fontWeight":"800"}},"fontSize":"max-48"} -->
									<h3 class="has-text-align-center has-max-48-font-size" id="let-s-connect" style="font-style:normal;font-weight:800;margin-bottom:20px">' . esc_html__( 'Let’s Connect', 'boo' ) . '</h3>
									<!-- /wp:heading -->

									<!-- wp:paragraph {"align":"center","fontSize":"large"} -->
									<p class="has-text-align-center has-large-font-size">Quisque aliquam nisl quis metus taylor feugiat. Lorem ipsum dolor sit amet, consectetur adipiscing vestibulum vitae gravida non diam accumsan.</p>
									<!-- /wp:paragraph -->
